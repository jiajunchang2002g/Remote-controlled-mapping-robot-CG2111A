...
#define KEY_FILENAME "laptop.key"
#define CLIENT_CERT_FILENAME "laptop.csr"
#define CA_CERT_FILENAME "signing.pem"
/* END TODO */
void connectToServer(const char *serverName, int portNum)
{
    /* TODO: Create a new client */
    createClient(serverName, portNum, 1, CA_CERT_FILENAME, SERVER_NAME_ON_CERT, 1, CLIENT_CERT_FILENAME, KEY_FILENAME, readerThread, writerThread);
    /* END TODO */
}
